...
export default function VidshopQuote() {
  return (
    <SectionComponent className="flex flex-col items-center justify-center text-center">
      ...
      <p className="mt-8 text-white/80 leading-8 text-xl">
      ...
      <Link href="#" className="p-4 bg-lightPink hover:bg-darkPink md:w-1/3 text-white hover:text-white font-bold text-center rounded-lg mt-10">
